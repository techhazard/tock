...
pub struct Registers {
    pub contorl: WriteOnly<u32, Control::Register>,
    pub mode: ReadWrite<u32, Mode::Register>,
    pub read_data: ReadOnly<u32>,
    pub transmit_data: WriteOnly<u32, TransmitData::Register>,
    pub status: ReadOnly<u32, Status::Register>,
    pub interrupt_enable: WriteOnly<u32, InterruptFlags::Register>,
    pub interrupt_diable: WriteOnly<u32, InterruptFlags::Register>,
    pub interrupt_mask: ReadOnly<u32, InterruptFlags::Register>,
    _reserved0: [ReadOnly<u32>; 4],
    pub chip_select: [ReadWrite<u32, ChipSelectParams::Register>; 4],
    _reserved1: [ReadOnly<u32>; 41],
    pub write_protection_control: ReadWrite<u32, WriteProtectionControl::Register>,
    pub write_protection_status: ReadOnly<u32>,
